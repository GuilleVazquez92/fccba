...
import { IonHeader, IonToolbar, IonTitle, IonContent, IonPage, IonButtons, IonMenuButton, IonRow, IonCol, IonButton, IonList, IonItem, IonLabel, IonInput, IonText, IonAlert, IonToast, IonModal, IonCheckbox, IonIcon } from '@ionic/react';
import api from '../api';
...
const SignUp = () => {
  ...
  const { user, setUser, predio, turno } = useContext(DataContext);
  ...
  useEffect(() => {
    if (user && predio && turno) {
      history.push('/booking');
    } else if (user && predio) {
      history.push(`/predio/${predio._id}`)
    } else if (user) {
    ...
    if(firstName && lastName && email && password) {
      ...
      try {
        const userData = await api.auth.register({
          firstName, lastName, dni, email, password, phone}, 
      ...
      setErrorMessage('Te falto completar algun campo.');
      setShowAlert(false);
    }
  };
  ...
  return (
    <IonPage id="signup-page">
      ...
      <IonContent>
        ...
        <form noValidate onSubmit={(e) => register(e)}>
          <IonList className="form-fields mx-2 py-0">
            ...
            <IonItem>
              <IonInput 
                ...
                name="lastName" type="text" value={lastName} spellCheck={false} autocapitalize="off" onIonChange={e => {
            ...
            <IonItem>
              <IonInput 
                placeholder="Dni"
                name="dni" type="text" value={dni} spellCheck={false} autocapitalize="off" onIonChange={e => {
                setDni(parseInt(e.detail.value));
              }}
                required>
              </IonInput>
            </IonItem>
            <IonItem>
              <IonInput 
                placeholder="Email"
                name="email" type="text" value={email} spellCheck={false} autocapitalize="off" onIonChange={e => {
            ...
            <IonItem>
              <IonInput 
                ...
                description="Sin 15."
                name="phone" type="number" value={phone} spellCheck={false} autocapitalize="off" onIonChange={e => {
            ...
            <IonItem>
              <IonCheckbox checked={checked} onClick={e => setShowModal(true)} />
              <IonLabel> Aceptas los Términos y Condiciones ?</IonLabel>
            </IonItem>
          </IonList>    
          <IonRow>
            <IonCol>
              <IonButton type="submit" expand="block" disabled={!checked}>Crear</IonButton>
            </IonCol>
          </IonRow>
        </form>
        <IonModal isOpen={showModal}>
          ...
          <IonContent class="ion-padding">
            <h3 class="ion-padding-bottom">Términos y condiciones</h3>
...
son incorporados al presente por referencia.</p>
          <h4 class="ion-padding-top">CUALQUIER PERSONA QUE NO ACEPTE ESTOS TÉRMINOS Y CONDICIONES
...
durante la prestación del mismo. </p>
          <h4 class="ion-padding-top">CLAUSULA PRIMERA: El Registro</h4>
...
info.fc@gmail.com. </p>
<h4 class="ion-padding-top">CLAUSULA SEGUNDA: Operatoria de la Aplicación. </h4>
...
<h4 class="ion-padding-top">CLAUSULA TERCERA: Condiciones Particulares del Uso del Servicio.</h4>
...
<h4 class="ion-padding-top">CLAUSULA CUARTA: Uso de la Aplicación</h4>
...
<h4 class="ion-padding-top">CLAUSULA QUINTA: Cancelaciones y Penalidades</h4>
...
<h4 class="ion-padding-top">CLAUSULA SEXTA: Responsabilidad</h4>
...
<h4 class="ion-padding-top">CLAUSULA SEPTIMA: Uso y Garantía de la Aplicación </h4>
...
<h4 class="ion-padding-top">CLAUSULA OCTAVA: Derechos de Propiedad Intelectual e Industrial </h4>
...
<h4 class="ion-padding-top">CLAUSULA NOVENA: Protección de Datos</h4>
...
Datos Personales). </p>
<h4 class="ion-padding-top">CLAUSULA DECIMA: Cancelación o cierre de la Cuenta</h4>
...
<h4 class="ion-padding-top">CLAUSULA DECIMO PRIMERA: Modificaciones de los Términos y Condiciones
Generales</h4>
...
<h4 class="ion-padding-top">CLAUSULA DECIMO SEGUNDA: Notificaciones</h4>
...
<h4 class="ion-padding-top">CLAUSULA DECIMO TERCERA: Cesión</h4>
...
acciones.</p>
<h4 class="ion-padding-top">CLAUSULA DECIMO CUARTA: Ley Aplicable y Jurisdicción</h4>
